...
import com.solvd.laba.mysql.MySQLProfessorDAO;
import com.solvd.laba.mysql.MySQLStudentDAO;
import com.solvd.laba.mysql.MySQLSubjectDAO;
...
//        }
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password)) {
            ...
            StudentZ newStudent = new StudentZ("Bill Skersgard", 23, "123 Main St", "555-1234", 2);
            try {
